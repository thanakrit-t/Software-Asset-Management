...
begin
  ...
  loop
    ...
    insert into public.license_entitlements (
      ...
      legacy_install_date,license_key_masked,serial_number_masked,remark,
      ...
      'all_sites',license_row.normalized_purchase_date,
...
grant execute on function public.publish_import_batch(uuid,integer,boolean) to authenticated;
